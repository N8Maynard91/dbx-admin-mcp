/**
 * Function to check the status of an asynchronous job for upload_session/finish_batch in Dropbox.
 *
...
const executeFunction = async ({ async_job_id }) => {
  const url = 'https://api.dropboxapi.com/2/files/upload_session/finish_batch/check';
...
/**
 * Tool configuration for checking the status of an asynchronous job in Dropbox.
 * @type {Object}
 */
const apiTool = {
  ...
  definition: {
    type: 'function',
    function: {
      name: 'upload_session_finish_batch_check',
      description: 'Check the status of an asynchronous job for upload_session/finish_batch in Dropbox.',
      parameters: {
        type: 'object',
        properties: {
          async_job_id: {
